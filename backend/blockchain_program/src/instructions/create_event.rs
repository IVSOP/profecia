...
pub fn create_event(accounts: &[AccountInfo], args: &CreateEventArgs) -> ProgramResult {
    let [payer, event, usdc_mint, treasury, system_program, token_program, associated_token_program, rest @ ..] =
        accounts
    else {
